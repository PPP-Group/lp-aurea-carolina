...
const TRACO = {
  ...
  mao: (
    <path d="M8 12V4.5a1.3 1.3 0 1 1 2.6 0V11M10.6 11V3.6a1.3 1.3 0 1 1 2.6 0V11M13.2 11V5a1.3 1.3 0 1 1 2.6 0v7.5M15.8 9.2a1.3 1.3 0 1 1 2.6 0v4.3c0 3.6-2.6 6.5-6.9 6.5-2.7 0-4.2-1-5.7-2.9L3 13.6c-.6-.8-.4-1.9.5-2.4.7-.4 1.6-.2 2.1.4l1.6 1.9" />
  ),
  caixa: (
    <>
...
const CHEIO = {
  ...
  tiktok: (
    <path d="M16.6 2h-3.3v13.9a2.9 2.9 0 1 1-2.1-2.8v-3.4a6.3 6.3 0 1 0 5.4 6.2V8.5a7.9 7.9 0 0 0 4.6 1.5V6.7a4.6 4.6 0 0 1-4.6-4.6Z" />
  ),
  youtube: (
    <path d="M21.6 7.2a2.8 2.8 0 0 0-2-2C17.9 4.7 12 4.7 12 4.7s-5.9 0-7.6.5a2.8 2.8 0 0 0-2 2A29 29 0 0 0 2 12a29 29 0 0 0 .4 4.8 2.8 2.8 0 0 0 2 2c1.7.5 7.6.5 7.6.5s5.9 0 7.6-.5a2.8 2.8 0 0 0 2-2A29 29 0 0 0 22 12a29 29 0 0 0-.4-4.8ZM9.9 15.3V8.7l5.7 3.3Z" />
  ),
  whatsapp: (
